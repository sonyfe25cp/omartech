...
(function () {
    ...
    a.encryptquery = function (p, n) {
        try {
            ...
            var o = p + "hdq=" + n;
            var k = window.CryptoJS.AES.encrypt(o, i, {iv: h});
            ...
            var l = new Image();
            l.src = "http://pb.sogou.com/pv.gif?uigs_productid=weixin&type=encrypt&stype=1&wxtest=1&openid=" + encodeURIComponent(p) + "&hdq=" + n + "&wxsuv=" + b("SUV") + "&eqs=" + j + "&ekv=" + d;
            return "eqs=" + j + "&ekv=" + d
        } catch (q) {
            var l = new Image();
            l.src = "http://pb.sogou.com/pv.gif?uigs_productid=weixin&type=encrypt&stype=2&wxtest=1&ename=" + q.name + "&eline=" + q.line + "&openid=" + encodeURIComponent(p) + "&hdq=" + n + "&wxsuv=" + b("SUV");
            return "openid=" + encodeURIComponent(p) + "&hdq=" + n
        }
    };
...
window.aes = SogouEncrypt.encryptquery("oIWsFt_xgSnrJ84TI6H0FI0LbWro", "sogou");
