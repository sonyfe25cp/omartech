...
Devise.data_mapper_validation_messages = {
  :not_found => '输入不存在',
  :blank => '输入不能为空',
  :expired => '会话已经过期',
  :absent                   => '%s 不能填写',
  ...
  :accepted                 => '输入不被接受',
  :nil                      => '不能为空',
  :length_between           => '%s 长度必须大于 %s 并小于 %s 字节',
  :too_long                 => '%s 最大长度为 %s 字节',
  :too_short                => '%s 最小长度为 %s 字节',
  :wrong_length             => '%s 长度必须为 %s 字节',
  :taken                    => '输入已经存在',
  :not_a_number             => '输入不是一个数字',
  :not_an_integer           => '输入不是一个整数',
  :greater_than             => '%s 必须大于 %s',
  :greater_than_or_equal_to => '%s 必须大于或等于 %s',
  :equal_to                 => '%s 必须等于 %s',
  :not_equal_to             => '%s 必须不等于 %s',
  :less_than                => '%s 必须小于 %s',
  :less_than_or_equal_to    => '%s 必须小于或者等于 %s',
  :value_between            => '%s 必须大于 %s 并小于 %s',
  :primitive                => '%s 类型必须为 %s'
}
...
Devise.setup do |config|
  ...
  config.mailer_sender = "admin@true_loser.cn"
  ...
  # config.pepper = "ab8d2174ca7aac2e08c8e878dc8a93f7699700cf7ff0f1e5a5c9b971f6137b067e5f7dbbf44751b1104f5e9a08d22ab37ca1e3a29f5b8f7d5c094c2863ed743b"
  ...
  #config.omniauth :weibo, '1943554380', 'dd4881bb02858fc7b754dce49bf0017e', :scope => 'user,public_repo'
